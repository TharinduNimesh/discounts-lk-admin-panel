...
const sponsershipCategories = ['Grocery', 'Restaurants', 'Hotels', 'Clothing', 'Jwellery', 'Service', 'Other'];
            ...
            <div class="grid grid-cols-1 lg:grid-cols-1 gap-3">
                            ...
                            <UContent>
                                <div class="flex flex-row gap-10 justify-between">
                                    <div class="flex justify-start">
                                        <h3 class="text-xl uppercase text-gray-800 dark:text-gray-200 font-semibold">
                                            Manage Stores
                                        </h3>
                                    </div>
                                    <div class="flex justify-end">
                                        <UButton label="new Store" to="/app/stores/new" />
                                    </div>
                                </div>
                            </UContent>
                        </div>
                        ...
                        <div class="p-3 border border-primary/10 rounded-lg">
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-3">
                                <div
                                    ...
                                    <h3 class="text-xs uppercase text-gray-500 font-semibold mt-2">
                                        Total Stores Count
                                    </h3>
                        ...
                        <UTable :columns="totalShopColumns" :rows="totalShopData">
                            <template #actions-data="{ row }">
                                <div class="flex gap-3">
                                    <UDropdown :items="productListAction" :ui="{
                                        item: {
                                        ...
                                        <UButton icon="solar:menu-dots-bold" variant="ghost" color="gray" />
                                    </UDropdown>
                                </div>
                            </template>
                        </UTable>
                    ...
                    <UCard :ui="{
                        ...
                        <div class="grid grid-cols-1 gap-4 mt-3">
                            <div class="grid grid-cols-1 gap-3">
                                <UContent>
                                    ...
                                    <div class="flex flex-col justify-between">
                                        <div class="flex flex-col">
                                            <h3 class="text-xl text-gray-800 dark:text-gray-200 font-semibold">
                                                Store
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <UFormGroup label="Sponsership Period" class="mt-6">
                                        <UInput placeholder="60 Days" icon="material-symbols-light:calendar-clock" />
                                    </UFormGroup>
                                ...
                                <UContent>
                                    ...
                                    <UTable :columns="branchesAddedColumns" :rows="branchesAddedData" />
                        ...
                        <template #footer>
                            <div class="flex justify-end gap-3">
                                <UButton label="Close" color="gray" @click="isMoreShopInformationModelOpen = false" />
                            </div>
                        </template>
                    </UCard>
                </UModal>
                ...
                <UModal v-model="isEditShopInformationModelOpen">
                    <UCard :ui="{
                        ...
                        <div class="grid grid-cols-1 gap-4 mt-6">
                            <div class="grid grid-cols-1 gap-3">
                                <UContent>
                                    ...
                                    <UFormGroup label="Store Category" class="mt-6">
                                        <USelectMenu icon="material-symbols-light:list-alt-add-sharp" class="mt-2"
                                            v-model="sponsershipSelected" :options="sponsershipCategories" multiple
                                ...
                                <UContent>
                                    ...
                                    <UFormGroup label="Location" class="mt-6">
                                        <UInput placeholder="Location" icon="icomoon-free:location" />
                                    </UFormGroup>
                                    ...
                                    <UFormGroup label="Opening Hours" class="mt-6">
                                        <UInput placeholder="08:00 - 18:00"
                                ...
                                <UContent>
                                    ...
                                    <UTable :columns="branchesAddedColumns" :rows="branchesAddedData">
                                        <template #actions-data="{ row }">
                                            <div class="flex gap-3">
                                                <UDropdown :items="branchListAction" :ui="{
                                                    item: {
                                                        disabled: 'cursor-text select-text',
                                                    },
                                                }" :popper="{
                        ...
                        <template #footer>
                            <div class="flex justify-end gap-3">
                                <UButton label="Close" color="gray" @click="isEditShopInformationModelOpen = false" />
                                <UButton label="Save" />
                            </div>
                        </template>
                    </UCard>
